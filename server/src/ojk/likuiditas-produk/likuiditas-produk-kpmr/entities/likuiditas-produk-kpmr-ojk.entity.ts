// likuiditas-produk-kpmr-ojk.entity.ts
import {
  Entity,
...
@Index(['createdAt'])
export class KpmrLikuiditasProdukOjk {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @OneToMany(() => KpmrAspekLikuiditasProduk, (aspek) => aspek.kpmrOjk, {
    cascade: true,
    eager: false,
  })
  aspekList?: KpmrAspekLikuiditasProduk[];

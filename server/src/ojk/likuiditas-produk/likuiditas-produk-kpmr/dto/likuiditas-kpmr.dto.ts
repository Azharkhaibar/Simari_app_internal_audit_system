...
// ==================== MAIN DTOs ====================
export class CreateKpmrLikuiditasOjkDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrAspekLikuiditasDto],
...
export class UpdateKpmrLikuiditasOjkDto {
...
export class CreateKpmrAspekLikuiditasDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanLikuiditasDto],
...
export class UpdateKpmrAspekLikuiditasDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanLikuiditasDto {
...
export class UpdateKpmrPertanyaanLikuiditasDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

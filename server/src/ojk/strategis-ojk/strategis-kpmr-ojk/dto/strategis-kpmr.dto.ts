...
// ==================== MAIN DTOs ====================
export class CreateKpmrStrategisOjkDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrAspekStrategisDto],
...
export class UpdateKpmrStrategisOjkDto {
...
export class CreateKpmrAspekStrategisDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanStrategisDto],
...
export class UpdateKpmrAspekStrategisDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanStrategisDto {
...
export class UpdateKpmrPertanyaanStrategisDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

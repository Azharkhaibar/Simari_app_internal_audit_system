...
export class OperasionalController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all Operasional data or by year/quarter' })
  ...
  @Get('active')
  @ApiOperation({ summary: 'Get active Operasional data' })
  @ApiResponse({
    status: 200,
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get Operasional by ID' })
  ...
  @Post()
  @ApiOperation({ summary: 'Create new Operasional data' })
  ...
  @Put(':id')
  @ApiOperation({ summary: 'Update Operasional data' })
  @ApiParam({ name: 'id', type: Number })
  @ApiBody({ type: UpdateOperasionalDto })
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Delete Operasional data' })
  @ApiParam({ name: 'id', type: Number })
  ...
  @Get(':id/parameters')
  @ApiOperation({ summary: 'Get all parameters for specific Operasional' })
  @ApiParam({ name: 'id', type: Number })
  @ApiResponse({
    status: 200,
    description: 'Parameters retrieved successfully',
  })
  async getParameters(@Param('id', ParseIntPipe) operasionalId: number) {
  ...
  async addParameter(
    ...
    const userId = req.user?.id || 'system';
    return this.operasionalService.addParameter(
      operasionalId,
      createParamDto,
      userId,
    );
  ...
  async updateParameter(
    ...
    const userId = req.user?.id || 'system';
    return this.operasionalService.updateParameter(
      operasionalId,
      parameterId,
      updateParamDto,
      userId,
  ...
  async removeParameter(
    ...
    const userId = req.user?.id || 'system';
    return this.operasionalService.removeParameter(
      operasionalId,
      parameterId,
      userId,
    );
  ...
  async addNilai(
    ...
    const userId = req.user?.id || 'system';
    return this.operasionalService.addNilai(
      operasionalId,
      parameterId,
      createNilaiDto,
      userId,
  ...
  async updateNilai(
    ...
    const userId = req.user?.id || 'system';
    return this.operasionalService.updateNilai(
      operasionalId,
      parameterId,
      nilaiId,
      updateNilaiDto,
  ...
  async copyNilai(
    ...
    const userId = req.user?.id || 'system';
    return this.operasionalService.copyNilai(
      operasionalId,
      parameterId,
      nilaiId,
      userId,
  ...
  async removeNilai(
    ...
    const userId = req.user?.id || 'system';
    return this.operasionalService.removeNilai(
      operasionalId,
      parameterId,
      nilaiId,
      userId,
  ...
  @ApiResponse({ status: 404, description: 'Data not found' })
  async exportToExcel(@Param('id', ParseIntPipe) operasionalId: number) {
  ...
  private async getOperasionalByIdOrThrow(operasionalId: number) {

...
// ==================== MAIN DTOs ====================
export class CreateKpmrOperasionalOjkDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrAspekOperasionalDto],
...
export class UpdateKpmrOperasionalOjkDto {
...
export class CreateKpmrAspekOperasionalDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanOperasionalDto],
...
export class UpdateKpmrAspekOperasionalDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanOperasionalDto {
...
export class UpdateKpmrPertanyaanOperasionalDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

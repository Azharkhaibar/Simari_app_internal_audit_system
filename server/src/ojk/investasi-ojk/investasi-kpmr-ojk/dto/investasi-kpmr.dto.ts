...
// ==================== MAIN DTOs ====================
export class CreateKpmrInvestasiOjkDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrAspekInvestasiDto],
...
export class UpdateKpmrInvestasiOjkDto {
...
export class CreateKpmrAspekInvestasiDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanInvestasiDto],
...
export class UpdateKpmrAspekInvestasiDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanInvestasiDto {
...
export class UpdateKpmrPertanyaanInvestasiDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

...
export class KpmrInvestasiOjk {
  ...
  @OneToMany(() => KpmrAspekInvestasi, (aspek) => aspek.kpmrOjk, {
    cascade: true,
    eager: false,
  })
  aspekList?: KpmrAspekInvestasi[];

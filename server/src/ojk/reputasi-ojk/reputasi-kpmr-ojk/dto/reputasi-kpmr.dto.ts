...
// ==================== MAIN DTOs ====================
export class CreateKpmrReputasiOjkDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrAspekReputasiDto],
...
export class UpdateKpmrReputasiOjkDto {
...
export class CreateKpmrAspekReputasiDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanReputasiDto],
...
export class UpdateKpmrAspekReputasiDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanReputasiDto {
...
export class UpdateKpmrPertanyaanReputasiDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

...
// ==================== MAIN DTOs ====================
export class CreateKpmrRentabilitasOjkDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrAspekRentabilitasDto],
...
export class UpdateKpmrRentabilitasOjkDto {
...
export class CreateKpmrAspekRentabilitasDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanRentabilitasDto],
...
export class UpdateKpmrAspekRentabilitasDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanRentabilitasDto {
...
export class UpdateKpmrPertanyaanRentabilitasDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

...
// ==================== MAIN DTOs ====================
export class CreateKpmrPermodalanOjkDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrAspekPermodalanDto],
...
export class UpdateKpmrPermodalanOjkDto {
...
export class CreateKpmrAspekPermodalanDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanPermodalanDto],
...
export class UpdateKpmrAspekPermodalanDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanPermodalanDto {
...
export class UpdateKpmrPertanyaanPermodalanDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

...
import { KpmrAspekPermodalan } from './permodalan-kpmr-aspek.entity';

@Entity('kpmr_permodalan_ojk')
@Index(['year', 'quarter'])  // ✅ HAPUS { unique: true }
@Index(['isActive', 'year', 'quarter'])
@Index(['createdAt'])
export class KpmrPermodalanOjk {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @OneToMany(() => KpmrAspekPermodalan, (aspek) => aspek.kpmrOjk, {
    cascade: true,
    eager: false,
  })
  aspekList?: KpmrAspekPermodalan[];

// peringkat-komposit/peringkat-komposit.module.ts
import { Module } from '@nestjs/common';
import { TypeOrmModule } from '@nestjs/typeorm';
import { PeringkatKompositController } from './peringkat-komposit.controller';
...
@Module({
  ...
  controllers: [PeringkatKompositController],
  providers: [PeringkatKompositService],
  exports: [PeringkatKompositService],
})
export class PeringkatKompositOjkModule {}
...
export class KpmrTatakelolaOjk {
  ...
  @OneToMany(() => KpmrAspekTatakelola, (aspek) => aspek.kpmrOjk, {
    cascade: true,
    eager: false,
  })
  aspekList?: KpmrAspekTatakelola[];

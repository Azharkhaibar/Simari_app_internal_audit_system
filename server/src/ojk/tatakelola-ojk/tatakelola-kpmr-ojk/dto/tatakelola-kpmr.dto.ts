...
// ==================== MAIN DTOs ====================
export class CreateKpmrTatakelolaOjkDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrAspekTatakelolaDto],
...
export class UpdateKpmrTatakelolaOjkDto {
...
export class CreateKpmrAspekTatakelolaDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanTatakelolaDto],
...
export class UpdateKpmrAspekTatakelolaDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanTatakelolaDto {
...
export class UpdateKpmrPertanyaanTatakelolaDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

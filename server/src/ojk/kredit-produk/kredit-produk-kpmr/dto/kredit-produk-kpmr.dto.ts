...
// ==================== MAIN DTOs ====================
export class CreateKpmrKreditOjkDto {
...
export class UpdateKpmrKreditOjkDto {
...
export class CreateKpmrAspekKreditDto {
  ...
  @ApiPropertyOptional({
    type: () => [CreateKpmrPertanyaanKreditDto],
...
export class UpdateKpmrAspekKreditDto {
  @ApiPropertyOptional({ description: 'Nomor aspek', example: '1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;
...
export class CreateKpmrPertanyaanKreditDto {
...
export class UpdateKpmrPertanyaanKreditDto {
  @ApiPropertyOptional({ description: 'Nomor pertanyaan', example: '1.1.1' })
  @IsOptional()
  @IsString()
  nomor?: string;

// src/features/Dashboard/pages/RiskProfile/pages/Kepatuhan/controllers/kpmr-kepatuhan.service.ts
import {
  Injectable,
  NotFoundException,
  ConflictException,
...
export class KPMRKepatuhanService {
  ...
  constructor(
    ...
    private readonly definitionRepo: Repository<KPMRKepatuhanDefinition>,

    @InjectRepository(KPMRKepatuhanScore)
    private readonly scoreRepo: Repository<KPMRKepatuhanScore>,

    @InjectRepository(KPMRKepatuhanAspect)
    private readonly aspectRepo: Repository<KPMRKepatuhanAspect>,

    @InjectRepository(KPMRKepatuhanQuestion)
    private readonly questionRepo: Repository<KPMRKepatuhanQuestion>,
  ) {}
  ...
  async validateDefinitionExists(
    definitionId: number,
  ): Promise<KPMRKepatuhanDefinition> {
  ...
  async createAspect(
    createDto: CreateKPMRKepatuhanAspectDto,
  ): Promise<KPMRKepatuhanAspect> {
    this.logger.log(
  ...
  async findAllAspects(year?: number): Promise<KPMRKepatuhanAspect[]> {
    const where: any = {};
  ...
  async findAspectById(id: number): Promise<KPMRKepatuhanAspect> {
  ...
  async updateAspect(
    id: number,
    updateDto: UpdateKPMRKepatuhanAspectDto,
  ): Promise<KPMRKepatuhanAspect> {
  ...
  async createQuestion(
    createDto: CreateKPMRKepatuhanQuestionDto,
  ): Promise<KPMRKepatuhanQuestion> {
    this.logger.log(
  ...
  async findAllQuestions(year?: number): Promise<KPMRKepatuhanQuestion[]> {
    const where: any = {};
    if (year) where.year = year;
  ...
  async findQuestionById(id: number): Promise<KPMRKepatuhanQuestion> {
  ...
  async updateQuestion(
    id: number,
    updateDto: UpdateKPMRKepatuhanQuestionDto,
  ): Promise<KPMRKepatuhanQuestion> {
  ...
  async createOrUpdateDefinition(
    createDto: CreateKPMRKepatuhanDefinitionDto,
    createdBy?: string,
  ): Promise<KPMRKepatuhanDefinition> {
    this.logger.log(
  ...
  async findAllDefinitions(): Promise<KPMRKepatuhanDefinition[]> {
  ...
  async findDefinitionById(id: number): Promise<KPMRKepatuhanDefinition> {
    const definition = await this.definitionRepo.findOne({
      where: { id },
      relations: ['question', 'scores'],
    });
  ...
  async updateDefinition(
    id: number,
    updateDto: UpdateKPMRKepatuhanDefinitionDto,
    updatedBy?: string,
  ): Promise<KPMRKepatuhanDefinition> {
  ...
  async createOrUpdateScore(
    createDto: CreateKPMRKepatuhanScoreDto,
    createdBy?: string,
  ): Promise<KPMRKepatuhanScore> {
  ...
  async findAllScores(): Promise<KPMRKepatuhanScore[]> {
  ...
  async findScoreById(id: number): Promise<KPMRKepatuhanScore> {
  ...
  async updateScore(
    id: number,
    updateDto: UpdateKPMRKepatuhanScoreDto,
    updatedBy?: string,
  ): Promise<KPMRKepatuhanScore> {
  ...
  async getKPMRFullData(year: number): Promise<any> {
    this.logger.log(`Getting full KPMR Kepatuhan data for year: ${year}`);
    const definitions = await this.definitionRepo.find({
      where: { year },
      relations: ['scores'],
      order: { aspekNo: 'ASC', sectionNo: 'ASC' },

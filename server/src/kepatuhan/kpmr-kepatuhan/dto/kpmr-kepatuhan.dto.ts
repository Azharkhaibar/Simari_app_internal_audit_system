// src/features/Dashboard/pages/RiskProfile/pages/Kepatuhan/dto/kpmr-kepatuhan.dto.ts
import {
  IsNotEmpty,
  IsString,
  IsNumber,
...
// ============================================================================
export class CreateKPMRKepatuhanAspectDto {
  ...
  @ApiProperty({
    example: 'Tata Kelola Risiko Kepatuhan',
...
export class UpdateKPMRKepatuhanAspectDto {
  ...
  @ApiPropertyOptional({ example: 'Tata Kelola Risiko Kepatuhan' })
  @IsOptional()
  @IsString()
  @Length(1, 255)
  aspekTitle?: string;
...
// ============================================================================
export class CreateKPMRKepatuhanQuestionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
  @IsInt({ message: 'Tahun harus berupa angka' })
  @Type(() => Number)
  ...
  @ApiProperty({
    example: 'Bagaimana perumusan tingkat risiko kepatuhan yang akan diambil?',
...
export class UpdateKPMRKepatuhanQuestionDto {
  @ApiPropertyOptional({ example: 'Aspek 1' })
  @IsOptional()
  @IsString()
  @Length(1, 50)
...
// ============================================================================
export class CreateKPMRKepatuhanDefinitionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
...
export class UpdateKPMRKepatuhanDefinitionDto {
...
// ============================================================================
export class CreateKPMRKepatuhanScoreDto {
...
export class UpdateKPMRKepatuhanScoreDto {
  @ApiPropertyOptional()
  @IsOptional()
  @IsInt()
  @Type(() => Number)

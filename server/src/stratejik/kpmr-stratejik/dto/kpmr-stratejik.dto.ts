// src/features/Dashboard/pages/RiskProfile/pages/Stratejik/dto/kpmr-stratejik.dto.ts
import {
  IsNotEmpty,
  IsString,
  IsNumber,
...
// ============================================================================
export class CreateKPMRStratejikAspectDto {
  ...
  @ApiProperty({
    example: 'Tata Kelola Risiko Stratejik',
...
export class UpdateKPMRStratejikAspectDto {
  ...
  @ApiPropertyOptional({ example: 'Tata Kelola Risiko Stratejik' })
  @IsOptional()
  @IsString()
  @Length(1, 255)
  aspekTitle?: string;
...
// ============================================================================
export class CreateKPMRStratejikQuestionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
  @IsInt({ message: 'Tahun harus berupa angka' })
  @Type(() => Number)
  ...
  @ApiProperty({
    example: 'Bagaimana perumusan tingkat risiko stratejik yang akan diambil?',
...
export class UpdateKPMRStratejikQuestionDto {
  @ApiPropertyOptional({ example: 'Aspek 1' })
  @IsOptional()
  @IsString()
  @Length(1, 50)
...
// ============================================================================
export class CreateKPMRStratejikDefinitionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
...
export class UpdateKPMRStratejikDefinitionDto {
...
// ============================================================================
export class CreateKPMRStratejikScoreDto {
...
export class UpdateKPMRStratejikScoreDto {
  @ApiPropertyOptional()
  @IsOptional()
  @IsInt()
  @Type(() => Number)

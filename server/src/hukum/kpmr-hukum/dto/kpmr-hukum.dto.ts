// src/features/Dashboard/pages/RiskProfile/pages/Hukum/dto/kpmr-hukum.dto.ts
import {
  IsNotEmpty,
  IsString,
  IsNumber,
...
// ============================================================================
export class CreateKPMRHukumAspectDto {
  ...
  @ApiProperty({
    example: 'Tata Kelola Risiko Hukum',
...
export class UpdateKPMRHukumAspectDto {
  ...
  @ApiPropertyOptional({ example: 'Tata Kelola Risiko Hukum' })
  @IsOptional()
  @IsString()
  @Length(1, 255)
  aspekTitle?: string;
...
// ============================================================================
export class CreateKPMRHukumQuestionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
  @IsInt({ message: 'Tahun harus berupa angka' })
  @Type(() => Number)
  ...
  @ApiProperty({
    example: 'Bagaimana perumusan tingkat risiko hukum yang akan diambil?',
...
export class UpdateKPMRHukumQuestionDto {
  @ApiPropertyOptional({ example: 'Aspek 1' })
  @IsOptional()
  @IsString()
  @Length(1, 50)
...
// ============================================================================
export class CreateKPMRHukumDefinitionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
...
export class UpdateKPMRHukumDefinitionDto {
...
// ============================================================================
export class CreateKPMRHukumScoreDto {
...
export class UpdateKPMRHukumScoreDto {
  @ApiPropertyOptional()
  @IsOptional()
  @IsInt()
  @Type(() => Number)

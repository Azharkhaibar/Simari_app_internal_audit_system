// src/features/Dashboard/pages/RiskProfile/pages/Hukum/entities/kpmr-hukum-definisi.entity.ts
import {
  Entity,
...
import { KPMRHukumScore } from './kpmr-hukum-skor.entity';

@Entity('kpmr_hukum_definisi_holding')
@Index('IDX_KPMR_HUKUM_DEF_YEAR_ASPECT', ['year', 'aspekNo', 'sectionNo'], {
  unique: true,
})
export class KPMRHukumDefinition {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(() => KPMRHukumQuestion, { onDelete: 'CASCADE' })
  @JoinColumn([
  ...
  @OneToMany(() => KPMRHukumScore, (score) => score.definition)

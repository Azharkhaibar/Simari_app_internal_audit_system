// src/features/Dashboard/pages/RiskProfile/pages/Reputasi/dto/kpmr-reputasi.dto.ts
import {
  IsNotEmpty,
  IsString,
  IsNumber,
...
// ============================================================================
export class CreateKPMRReputasiAspectDto {
  ...
  @ApiProperty({
    example: 'Tata Kelola Risiko Reputasi',
...
export class UpdateKPMRReputasiAspectDto {
  ...
  @ApiPropertyOptional({ example: 'Tata Kelola Risiko Reputasi' })
  @IsOptional()
  @IsString()
  @Length(1, 255)
  aspekTitle?: string;
...
// ============================================================================
export class CreateKPMRReputasiQuestionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
  @IsInt({ message: 'Tahun harus berupa angka' })
  @Type(() => Number)
  ...
  @ApiProperty({
    example: 'Bagaimana perumusan tingkat risiko reputasi yang akan diambil?',
...
export class UpdateKPMRReputasiQuestionDto {
  @ApiPropertyOptional({ example: 'Aspek 1' })
  @IsOptional()
  @IsString()
  @Length(1, 50)
...
// ============================================================================
export class CreateKPMRReputasiDefinitionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
...
export class UpdateKPMRReputasiDefinitionDto {
...
// ============================================================================
export class CreateKPMRReputasiScoreDto {
...
export class UpdateKPMRReputasiScoreDto {
  @ApiPropertyOptional()
  @IsOptional()
  @IsInt()
  @Type(() => Number)

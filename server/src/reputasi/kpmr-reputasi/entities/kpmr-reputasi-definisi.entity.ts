// src/features/Dashboard/pages/RiskProfile/pages/Reputasi/entities/kpmr-reputasi-definisi.entity.ts
import {
  Entity,
...
import { KPMRReputasiScore } from './kpmr-reputasi-skor.entity';

@Entity('kpmr_reputasi_definisi_holding')
@Index(
  'IDX_KPMR_REPUTASI_DEF_YEAR_ASPECT',
  ['year', 'aspekNo', 'sectionNo'],
  {
    unique: true,
  },
)
export class KPMRReputasiDefinition {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(() => KPMRReputasiQuestion, { onDelete: 'CASCADE' })
  @JoinColumn([
  ...
  @OneToMany(() => KPMRReputasiScore, (score) => score.definition)

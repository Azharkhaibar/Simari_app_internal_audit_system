...
export default function KonsentrasiProdukInherentWrapper() {
  ...
  const {
    ...
    formatBobot,
    formatKategori,
  } = useKonsentrasiProdukIntegration(year, quarter);
    ...
    <div className="w-full space-y-6">
      ...
      <div className="bg-white rounded-lg border shadow p-4">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Konsentrasi Produk - Inherent Risk</h1>
...
function KonsentrasiProdukInherent({ rows, setRows, search, active, backendHandlers, isLoading, isLocked = false }) {
  ...
  return (
    <div className="w-full">
      <div className="flex justify-between mb-2 pr-2">
        <div>
          <h1 className="text-2xl font-semibold">Data Konsentrasi Produk - Inherent</h1>

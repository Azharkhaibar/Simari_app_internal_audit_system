  ...
  sortedRows.forEach((param) => {
    ...
    sortedNilaiList.forEach((nilai, ni) => {
      ...
      for (let subIndex = 0; subIndex < rowsForThisNilai; subIndex++) {
        ...
        writeCell(currentRow, 14, hasilText, { ...cellStyle, fill: { fgColor: { rgb: hasilBg } }, alignment: { horizontal: 'center', vertical: 'center' }, font: { name: 'Calibri', size: 11, bold: isMainRow } });

// services/pasar-produk-api.service.ts
import axios, { AxiosError } from 'axios';

const API_BASE_URL = 'http://localhost:5530/api/v1';

export const api_pasar_produk = axios.create({
...
api_pasar_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [pasar produk API] Error:', {
...
export default api_pasar_produk;
// services/likuiditas.api.service.ts
import axios, { AxiosError } from 'axios';

const API_BASE_URL = 'http://localhost:5530/api/v1';

export const api_likuiditas_produk = axios.create({
...
api_likuiditas_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [likuiditas produk API] Error:', {
...
export default api_likuiditas_produk;
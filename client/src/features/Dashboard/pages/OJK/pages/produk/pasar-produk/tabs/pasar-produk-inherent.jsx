...
import { usePasarProdukIntegration } from '../hook/inherent/pasar-produk.hook';
...
export default function PasarProdukInherentWrapper() {
  ...
  const {
    ...
    formatBobot,
    formatKategori,
  } = usePasarProdukIntegration(year, quarter);
    ...
    <div className="w-full space-y-6">
      ...
      <div className="bg-white rounded-lg border shadow p-4">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Pasar Produk - Inherent Risk</h1>
      ...
      {/* Komponen utama */}
      <PasarProdukInherent rows={rows} setRows={setRows} search={search} active={active} backendHandlers={backendHandlers} isLoading={isLoading} isLocked={currentInherentData?.isLocked} />
    </div>
  );
}

// Komponen utama - PERBAIKAN: Tambah prop isInitialLoading
function PasarProdukInherent({ rows, setRows, search, active, backendHandlers, isLoading, isLocked = false }) {

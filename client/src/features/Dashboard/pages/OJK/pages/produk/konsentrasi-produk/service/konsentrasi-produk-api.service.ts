...
export const api_konsentrasi_produk = axios.create({
...
api_konsentrasi_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [konsentrasi produk API] Error:', {
...
export default api_konsentrasi_produk;
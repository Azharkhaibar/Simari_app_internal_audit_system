// services/investasi.api.service.ts
import axios, { AxiosError } from 'axios';

const API_BASE_URL = 'http://localhost:5530/api/v1';

export const api_investasi_produk = axios.create({
...
api_investasi_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [investasi produk API] Error:', {
...
export default api_investasi_produk;

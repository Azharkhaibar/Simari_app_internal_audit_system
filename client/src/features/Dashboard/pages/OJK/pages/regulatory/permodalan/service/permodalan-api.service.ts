// services/permodalan.api.service.ts
import axios, { AxiosError } from 'axios';

const API_BASE_URL = 'http://localhost:5530/api/v1';

export const api_permodalan_produk = axios.create({
...
api_permodalan_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [permodalan produk API] Error:', {
...
export default api_permodalan_produk;

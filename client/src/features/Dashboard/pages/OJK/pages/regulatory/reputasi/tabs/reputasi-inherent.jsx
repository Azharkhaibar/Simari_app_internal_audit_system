// src/ojk/reputasi-produk/reputasi-produk-ojk/reputasi-produk-inherent.jsx
...
export default function ReputasiProdukInherentWrapper() {
  ...
  const {
    ...
    formatBobot,
    formatKategori,
  } = useReputasiProdukIntegration(year, quarter);
    ...
    <div className="w-full space-y-6">
      ...
      <div className="bg-white rounded-lg border shadow p-4">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Reputasi Produk - Inherent Risk</h1>
...
function ReputasiProdukInherent({ rows, setRows, search, active, backendHandlers, isLoading, isLocked = false }) {
  ...
  return (
    <div className="w-full">
      <div className="flex justify-between mb-2 pr-2">
        <div>
          <h1 className="text-2xl font-semibold">Data Reputasi Produk - Inherent</h1>

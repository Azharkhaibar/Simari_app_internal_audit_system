// services/tatakelola.api.service.ts
import axios, { AxiosError } from 'axios';

const API_BASE_URL = 'http://localhost:5530/api/v1';

export const api_tatakelola_produk = axios.create({
...
api_tatakelola_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [tatakelola produk API] Error:', {
...
export default api_tatakelola_produk;

// services/rentabilitas.api.service.ts
import axios, { AxiosError } from 'axios';

const API_BASE_URL = 'http://localhost:5530/api/v1';

export const api_rentabilitas_produk = axios.create({
...
api_rentabilitas_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [rentabilitas produk API] Error:', {
...
export default api_rentabilitas_produk;

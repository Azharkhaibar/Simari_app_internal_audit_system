// services/strategis.api.service.ts
import axios, { AxiosError } from 'axios';

const API_BASE_URL = 'http://localhost:5530/api/v1';

export const api_strategis_produk = axios.create({
...
api_strategis_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [strategis produk API] Error:', {
...
export default api_strategis_produk;

...
import api_investasi_produk from '../investasi-api.service';

// =============================================
// TYPES BERDASARKAN BACKEND ENTITY
// =============================================

export interface InvestasiProdukOjkEntity {
  id: number;
  year: number;
  quarter: number;
  isActive: boolean;
  parameters?: InvestasiParameterEntity[];
  summary?: {
...
export interface InvestasiParameterEntity {
  id: number;
  nomor?: string;
  judul: string;
  bobot: number;
  ...
  nilaiList?: InvestasiNilaiEntity[];
  orderIndex: number;
  investasiProdukOjkId: number;
  createdAt: Date;
  updatedAt: Date;
}

export interface InvestasiNilaiEntity {
  id: number;
  nomor?: string;
  judul: {
    type?: string;
...
export interface CreateInvestasiProdukInherentDto {
  year: number;
  quarter: number;
  isActive?: boolean;
  createdBy?: string;
...
export interface UpdateInvestasiProdukInherentDto {
  year?: number;
  quarter?: number;
  isActive?: boolean;
  summary?: {
...
export class InvestasiProdukService {
  private baseUrl = '/investasi';
  ...
  async findOrCreate(
    ...
    success: boolean;
    data: InvestasiProdukOjkEntity | null;
    isNew: boolean;
    message: string;
  }> {
  ...
  async ensureDataExists(year: number, quarter: number): Promise<InvestasiProdukOjkEntity> {
  ...
  async loadOrCreateData(year: number, quarter: number): Promise<InvestasiProdukOjkEntity> {
  ...
  public formatToFrontend(entity: InvestasiProdukOjkEntity | null): any[] {
  ...
  private handleError(error: any, operation: string, url?: string): never {
    ...
    console.error(`[InvestasiProdukService] Error in ${operation}:`, errorDetails);
  ...
  async findActive(): Promise<InvestasiProdukOjkEntity | null> {
    const url = `${this.baseUrl}/active`;
    this.logApiCall('GET', url);

    try {
      const response = await api_investasi_produk.get<InvestasiProdukOjkEntity>(url);
  ...
  async findByYearQuarter(year: number, quarter: number): Promise<InvestasiProdukOjkEntity | null> {
    ...
    try {
      const response = await api_investasi_produk.get<any>(url, { params });
  ...
  async getAll(): Promise<InvestasiProdukOjkEntity[]> {
    const url = this.baseUrl;
    this.logApiCall('GET', url);

    try {
      const response = await api_investasi_produk.get<any>(url);
  ...
  async getById(id: number): Promise<InvestasiProdukOjkEntity> {
  ...
  async create(createDto: CreateInvestasiProdukInherentDto): Promise<InvestasiProdukOjkEntity> {
    const url = this.baseUrl;
    this.logApiCall('POST', url, undefined, createDto);

    try {
      const response = await api_investasi_produk.post<InvestasiProdukOjkEntity>(url, createDto);
      return response.data;
    } catch (error: any) {
  ...
  async update(id: number, updateDto: UpdateInvestasiProdukInherentDto): Promise<InvestasiProdukOjkEntity> {
    const url = `${this.baseUrl}/${id}`;
    this.logApiCall('PUT', url, undefined, updateDto);

    try {
      const response = await api_investasi_produk.put<InvestasiProdukOjkEntity>(url, updateDto);
      return response.data;
    } catch (error: any) {
  ...
  async updateActiveStatus(id: number, isActive: boolean): Promise<InvestasiProdukOjkEntity> {
    const url = `${this.baseUrl}/${id}/status`;
    this.logApiCall('PUT', url, undefined, { isActive });

    try {
      const response = await api_investasi_produk.put<InvestasiProdukOjkEntity>(url, { isActive });
      return response.data;
    } catch (error: any) {
  ...
  async updateSummary(id: number, summary: UpdateInvestasiProdukInherentDto['summary']): Promise<InvestasiProdukOjkEntity> {
    const url = `${this.baseUrl}/${id}/summary`;
    this.logApiCall('PUT', url, undefined, { summary });

    try {
      const response = await api_investasi_produk.put<InvestasiProdukOjkEntity>(url, { summary });
      return response.data;
    } catch (error: any) {
  ...
  async remove(id: number): Promise<{ message: string; id: number }> {
    ...
    try {
      const response = await api_investasi_produk.delete<{ message: string; id: number }>(url);
      return response.data;
    } catch (error: any) {
  ...
  async addParameter(inherentId: number, dto: CreateParameterDto): Promise<InvestasiProdukOjkEntity> {
    ...
    try {
      ...
      const response = await api_investasi_produk.post<InvestasiProdukOjkEntity>(url, payload);
  ...
  async updateParameter(inherentId: number, parameterId: number, dto: UpdateParameterDto): Promise<InvestasiProdukOjkEntity> {
    ...
    try {
      ...
      const response = await api_investasi_produk.put<InvestasiProdukOjkEntity>(url, payload);
      return response.data;
    } catch (error: any) {
  ...
  async copyParameter(inherentId: number, parameterId: number): Promise<InvestasiProdukOjkEntity> {
    const url = `${this.baseUrl}/${inherentId}/parameters/${parameterId}/copy`;
    this.logApiCall('POST', url);

    try {
      const response = await api_investasi_produk.post<InvestasiProdukOjkEntity>(url);
      return response.data;
    } catch (error: any) {
  ...
  async removeParameter(inherentId: number, parameterId: number): Promise<InvestasiProdukOjkEntity> {
    const url = `${this.baseUrl}/${inherentId}/parameters/${parameterId}`;
    this.logApiCall('DELETE', url);

    try {
      const response = await api_investasi_produk.delete<InvestasiProdukOjkEntity>(url);
      return response.data;
    } catch (error: any) {
  ...
  async reorderParameters(inherentId: number, parameterIds: number[]): Promise<{ message: string }> {
    ...
    try {
      const response = await api_investasi_produk.put<{ message: string }>(url, { parameterIds });
      return response.data;
    } catch (error: any) {
  ...
  async addNilai(inherentId: number, parameterId: number, dto: CreateNilaiDto): Promise<InvestasiProdukOjkEntity> {
  ...
  async updateNilai(inherentId: number, parameterId: number, nilaiId: number, dto: UpdateNilaiDto): Promise<InvestasiProdukOjkEntity> {
  ...
  async copyNilai(inherentId: number, parameterId: number, nilaiId: number): Promise<InvestasiProdukOjkEntity> {
  ...
  async removeNilai(inherentId: number, parameterId: number, nilaiId: number): Promise<InvestasiProdukOjkEntity> {
    const url = `${this.baseUrl}/${inherentId}/parameters/${parameterId}/nilai/${nilaiId}`;
    this.logApiCall('DELETE', url);
  ...
  async reorderNilai(inherentId: number, parameterId: number, nilaiIds: number[]): Promise<{ message: string }> {
    ...
    try {
      const response = await api_investasi_produk.put<{ message: string }>(url, { nilaiIds });
      return response.data;
    } catch (error: any) {
  ...
  async importFromExcel(importData: any): Promise<InvestasiProdukOjkEntity> {
    const url = `${this.baseUrl}/import`;
    this.logApiCall('POST', url, undefined, importData);

    try {
      const response = await api_investasi_produk.post<InvestasiProdukOjkEntity>(url, importData);
      return response.data;
    } catch (error: any) {
  ...
  async getReferences(type?: string): Promise<ReferenceItem[]> {
    ...
    try {
      const response = await api_investasi_produk.get<ReferenceItem[]>(url, { params });
      return response.data;
    } catch (error: any) {
  ...
  async checkExists(year: number, quarter: number): Promise<{ exists: boolean; data: InvestasiProdukOjkEntity | null }> {
    try {
  ...
  async loadOrCreate(year: number, quarter: number): Promise<InvestasiProdukOjkEntity> {
    ...
    try {
      ...
      const createDto: CreateInvestasiProdukInherentDto = {
        year,
        quarter,
        isActive: true,
        createdBy: 'system',
      ...
      const fallbackData: InvestasiProdukOjkEntity = {
        id: -1,
        year,
        quarter,
        isActive: true,
  ...
  async getFormattedData(year?: number, quarter?: number): Promise<any[]> {
    ...
    try {
      let data: InvestasiProdukOjkEntity | null = null;
  ...
  async validateConnection(): Promise<boolean> {
    try {
      const response = await api_investasi_produk.get(this.baseUrl, { timeout: 5000 });
...
export const investasiProdukService = new InvestasiProdukService();
export default investasiProdukService;

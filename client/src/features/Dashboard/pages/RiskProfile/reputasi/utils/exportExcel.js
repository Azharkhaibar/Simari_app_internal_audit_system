...
/**
 * Export tabel Reputasi ke Excel.
 *
 ...
 * }} options
 */
export function exportReputasiToExcel(filteredRows, viewYear, viewQuarter, options = {}) {
  const { sheetName = `${viewYear}-${viewQuarter}`, filePrefix = 'FORM-REPUTASI', summaryLabel = 'Summary', groupBySection = false } = options;

...
/**
 * Export KPMR Reputasi ke Excel dengan layout yang sama seperti tabel web,
 * termasuk baris footer "Total Average Semua Aspek" di paling bawah.
 *
 * @param {{year:number, quarter:string, rows:Array}} params
 */
export function exportKPMRReputasiToExcel({ year, quarter, rows }) {
  ...
  XLSX.writeFile(wb, `KPMR-Reputasi-${year}-${quarter}.xlsx`);
}

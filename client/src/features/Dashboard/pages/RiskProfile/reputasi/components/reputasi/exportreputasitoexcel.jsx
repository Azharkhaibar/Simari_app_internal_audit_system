// ===================== Export Function for Reputasi Table =====================
...
export const exportReputasiToExcel = async ({ year, quarter, sections = [], filename = `Reputasi_${year}_${quarter}` }) => {
  try {
    // Validasi data
    ...
    // ===================== SHEET RINGKASAN =====================
    const summaryData = [['LAPORAN RISIKO REPUTASI BANK'], [`Periode: ${year} ${quarter}`], [''], ['No', 'Section', 'Bobot Section', 'Jumlah Indikator', 'Total Weighted']];
    ...
    // ===== SIMPAN KE FILE =====
    XLSX.utils.book_append_sheet(wb, ws, 'Data Reputasi');

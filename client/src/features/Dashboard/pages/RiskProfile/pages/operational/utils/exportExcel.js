...
/**
 * Export tabel Operasional ke Excel.
 *
 ...
 * }} options
 */
export function exportOperasionalToExcel(filteredRows, viewYear, viewQuarter, options = {}) {
  const { sheetName = `${viewYear}-${viewQuarter}`, filePrefix = 'FORM-OPERASIONAL', summaryLabel = 'Summary', groupBySection = false } = options;

// src/features/Dashboard/pages/RiskProfile/pages/Kepatuhan/KepatuhanPage.jsx
import React, { useState } from 'react';
// import { getCurrentQuarter, getCurrentYear } from '../utils/time';
// import { getCurrentQuarter, getCurrentYear } from './utils/kepatuhan/time';
// // import KepatuhanInherent from './components/KepatuhanInherent';
// import KepatuhanInherent from './kepatuhan-page';
// import KepatuhanKPMR from './kpmr_kepatuhan-page';

import { getCurrentQuarter, getCurrentYear } from './utils/time';
import KepatuhanInherent from './kepatuhan-page';
import KepatuhanKPMR from './kpmr-kepatuhan-page';
// ===================== Brand =====================
const PNM_BRAND = {
  primary: '#0068B3',
  primarySoft: '#E6F1FA',
  ...
  return (
    <div className="p-6 bg-[#f3f6f8] min-h-screen">
      ...
      <div className="mb-6 border-b border-gray-200">
        <nav className="flex space-x-8">
          <button
            ...
            className={`py-3 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === 'kepatuhan' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300'}`}
          >
            Kepatuhan
          </button>
      ...
      <div className="bg-white rounded-2xl shadow-md p-6">
        {/* ================= TAB: KEPATUHAN (INHERENT) ================= */}
        {activeTab === 'kepatuhan' && <KepatuhanInherent viewYear={viewYear} viewQuarter={viewQuarter} onViewYearChange={setViewYear} onViewQuarterChange={setViewQuarter} query={query} onQueryChange={setQuery} />}

        {/* ================= TAB: KPMR ================= */}
        {activeTab === 'kpmr' && <KepatuhanKPMR viewYear={viewYear} viewQuarter={viewQuarter} onViewYearChange={setViewYear} query={query} onQueryChange={setQuery} />}
      </div>
    </div>
  );
}

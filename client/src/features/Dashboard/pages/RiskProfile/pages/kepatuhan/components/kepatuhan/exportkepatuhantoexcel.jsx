// ===================== Export Function for Kepatuhan Table =====================
...
export const exportKepatuhanToExcel = async ({ year, quarter, sections = [], filename = `Kepatuhan_${year}_${quarter}` }) => {
  try {
    // Validasi data
    ...
    // ===================== SHEET RINGKASAN =====================
    const summaryData = [['LAPORAN RISIKO KEPATUHAN BANK'], [`Periode: ${year} ${quarter}`], [''], ['No', 'Section', 'Bobot Section', 'Jumlah Indikator', 'Total Weighted']];

// client/src/features/Dashboard/pages/RiskProfile/utils/exportExcelKepatuhan.js
...
/**
 * Export tabel Kepatuhan ke Excel.
 *
 ...
 * }} options
 */
export function exportKepatuhanToExcel(filteredRows, viewYear, viewQuarter, options = {}) {
  const { sheetName = `${viewYear}-${viewQuarter}`, filePrefix = 'FORM-KEPATUHAN', summaryLabel = 'Summary', groupBySection = false } = options;

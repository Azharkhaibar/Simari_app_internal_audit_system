// ===================== Export Function for Hukum Table =====================
...
export const exportHukumToExcel = async ({ year, quarter, sections = [], filename = `Hukum_${year}_${quarter}` }) => {
  try {
    // Validasi data
    ...
    // ===================== SHEET RINGKASAN =====================
    const summaryData = [['LAPORAN RISIKO HUKUM BANK'], [`Periode: ${year} ${quarter}`], [''], ['No', 'Section', 'Bobot Section', 'Jumlah Indikator', 'Total Weighted']];
    ...
    // ===== SIMPAN KE FILE =====
    XLSX.utils.book_append_sheet(wb, ws, 'Data Hukum');

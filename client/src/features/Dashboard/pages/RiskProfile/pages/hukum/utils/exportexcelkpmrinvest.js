...
/**
 * Export KPMR Hukum ke Excel dengan layout yang sama seperti tabel web,
 * termasuk baris footer "Total Average Semua Aspek" di paling bawah.
 *
 * @param {{year:number, quarter:string, rows:Array}} params
 */
export function exportKPMRHukumToExcel({ year, quarter, rows }) {
  ...
  XLSX.writeFile(wb, `KPMR-Hukum-${year}-${quarter}.xlsx`);
}

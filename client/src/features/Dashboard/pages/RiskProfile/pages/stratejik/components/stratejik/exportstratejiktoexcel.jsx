// ===================== Export Function for Stratejik Table =====================
...
export const exportStratejikToExcel = async ({ year, quarter, sections = [], filename = `Stratejik_${year}_${quarter}` }) => {
  try {
    // Validasi data
    ...
    // ===================== SHEET RINGKASAN =====================
    const summaryData = [['LAPORAN RISIKO STRATEJIK BANK'], [`Periode: ${year} ${quarter}`], [''], ['No', 'Section', 'Bobot Section', 'Jumlah Indikator', 'Total Weighted']];
    ...
    // ===== SIMPAN KE FILE =====
    XLSX.utils.book_append_sheet(wb, ws, 'Data Stratejik');

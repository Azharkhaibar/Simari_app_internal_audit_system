...
/**
 * Export tabel Stratejik ke Excel.
 *
 ...
 * }} options
 */
export function exportStratejikToExcel(filteredRows, viewYear, viewQuarter, options = {}) {
  const { sheetName = `${viewYear}-${viewQuarter}`, filePrefix = 'FORM-STRATEJIK', summaryLabel = 'Summary', groupBySection = false } = options;
